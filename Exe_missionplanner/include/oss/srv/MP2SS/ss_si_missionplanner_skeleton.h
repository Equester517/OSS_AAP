...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : ss_si_missionplanner_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_MP2SS_SERVICE_INTERFACE_SS_SI_MISSIONPLANNER_SKELETON_H
#define PARA_COM_GEN_OSS_SRV_MP2SS_SERVICE_INTERFACE_SS_SI_MISSIONPLANNER_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace skeleton
{
class SS_SI_missionplannerSkeleton;
...
public:
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            {
                mDdsInterface->CreateEvent<dds::oss::srv::MP2SS::LaneletRouteEventType>(kCallSign);
                break;
            }
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::oss::srv::MP2SS::LaneletRouteEventType _event_;
                ...
                return mDdsInterface->SendEvent<dds::oss::srv::MP2SS::LaneletRouteEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
...
public:
    ...
    SS_SI_missionplannerSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~SS_SI_missionplannerSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    SS_SI_missionplannerSkeleton(const SS_SI_missionplannerSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    SS_SI_missionplannerSkeleton& operator=(const SS_SI_missionplannerSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    SS_SI_missionplannerSkeleton(SS_SI_missionplannerSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    SS_SI_missionplannerSkeleton& operator=(SS_SI_missionplannerSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
        mProtocol = std::move(other.mProtocol);
...
#endif /// PARA_COM_GEN_OSS_SRV_MP2SS_SERVICE_INTERFACE_SS_SI_MISSIONPLANNER_SKELETON_H