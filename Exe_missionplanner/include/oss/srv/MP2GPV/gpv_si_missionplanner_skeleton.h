...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : gpv_si_missionplanner_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_MP2GPV_SERVICE_INTERFACE_GPV_SI_MISSIONPLANNER_SKELETON_H
#define PARA_COM_GEN_OSS_SRV_MP2GPV_SERVICE_INTERFACE_GPV_SI_MISSIONPLANNER_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace skeleton
{
class GPV_SI_missionplannerSkeleton;
...
public:
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            {
                mDdsInterface->CreateEvent<dds::oss::srv::MP2GPV::LaneletRouteEventType>(kCallSign);
                break;
            }
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::oss::srv::MP2GPV::LaneletRouteEventType _event_;
                ...
                return mDdsInterface->SendEvent<dds::oss::srv::MP2GPV::LaneletRouteEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
...
public:
    ...
    GPV_SI_missionplannerSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~GPV_SI_missionplannerSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    GPV_SI_missionplannerSkeleton(const GPV_SI_missionplannerSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    GPV_SI_missionplannerSkeleton& operator=(const GPV_SI_missionplannerSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    GPV_SI_missionplannerSkeleton(GPV_SI_missionplannerSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    GPV_SI_missionplannerSkeleton& operator=(GPV_SI_missionplannerSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
        mProtocol = std::move(other.mProtocol);
...
#endif /// PARA_COM_GEN_OSS_SRV_MP2GPV_SERVICE_INTERFACE_GPV_SI_MISSIONPLANNER_SKELETON_H