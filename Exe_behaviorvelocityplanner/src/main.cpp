...
/// EXECUTABLE NAME                   : Exe_behaviorvelocityplanner
...
exe_behaviorvelocityplanner::aa::Swc_behaviorvelocityplanner* g_swcSwc_behaviorvelocityplanner{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcSwc_behaviorvelocityplanner->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("BHVP", "Exe_behaviorvelocityplanner's main function")};
        ...
        exe_behaviorvelocityplanner::aa::Swc_behaviorvelocityplanner swcSwc_behaviorvelocityplanner;
        g_swcSwc_behaviorvelocityplanner = &swcSwc_behaviorvelocityplanner;
        
        // initialize software component
        proceed = swcSwc_behaviorvelocityplanner.Initialize();
        
        if (proceed)
        {
            // start software component
            swcSwc_behaviorvelocityplanner.Start();
            ...
            if (exec.HasValue())
            {
                ...
                swcSwc_behaviorvelocityplanner.Run();
            }
            else
            {
