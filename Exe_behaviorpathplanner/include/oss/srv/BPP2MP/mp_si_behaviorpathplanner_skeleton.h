...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : mp_si_behaviorpathplanner_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_BPP2MP_SERVICE_INTERFACE_MP_SI_BEHAVIORPATHPLANNER_SKELETON_H
#define PARA_COM_GEN_OSS_SRV_BPP2MP_SERVICE_INTERFACE_MP_SI_BEHAVIORPATHPLANNER_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace skeleton
{
class MP_SI_behaviorpathplannerSkeleton;
...
public:
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            {
                mDdsInterface->CreateEvent<dds::oss::srv::BPP2MP::RerouteAvailabilityEventType>(kCallSign);
                break;
            }
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::oss::srv::BPP2MP::RerouteAvailabilityEventType _event_;
                ...
                return mDdsInterface->SendEvent<dds::oss::srv::BPP2MP::RerouteAvailabilityEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
...
public:
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                mDdsInterface->CreateEvent<dds::oss::srv::BPP2MP::PoseWithUuidStampedEventType>(kCallSign);
                break;
            }
            #endif /// PARA_DDS_IMPLEMENTATION
            default : break;
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::oss::srv::BPP2MP::PoseWithUuidStampedEventType _event_;
                _event_.instance_id() = mDdsInterface->GetInstanceId();
                _event_.data() = oss::type::autoware_planning_msgs::msg::PoseWithUuidStamped_ConvertToDdsType(data);
                return mDdsInterface->SendEvent<dds::oss::srv::BPP2MP::PoseWithUuidStampedEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
            default : return ara::core::Result<void>(ara::com::ComErrc::kNetworkBindingFailure);
        }
...
public:
    ...
    MP_SI_behaviorpathplannerSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~MP_SI_behaviorpathplannerSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    MP_SI_behaviorpathplannerSkeleton(const MP_SI_behaviorpathplannerSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    MP_SI_behaviorpathplannerSkeleton& operator=(const MP_SI_behaviorpathplannerSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    MP_SI_behaviorpathplannerSkeleton(MP_SI_behaviorpathplannerSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    MP_SI_behaviorpathplannerSkeleton& operator=(MP_SI_behaviorpathplannerSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
        mProtocol = std::move(other.mProtocol);
...
#endif /// PARA_COM_GEN_OSS_SRV_BPP2MP_SERVICE_INTERFACE_MP_SI_BEHAVIORPATHPLANNER_SKELETON_H