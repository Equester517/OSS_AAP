...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : pe_si_behaviorpathplanner_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_SKELETON_H
#define PARA_COM_GEN_OSS_SRV_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace skeleton
{
class PE_SI_behaviorpathplannerSkeleton;
...
public:
        ...
        , mProtocol(protocol)
    {
        switch (mProtocol)
        {
            ...
            {
                mDdsInterface->CreateEvent<dds::oss::srv::BPP2PE::PoseWithUuidStampedEventType>(kCallSign);
                break;
            }
    ...
    ara::core::Result<void> Send(const SampleType& data)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                dds::oss::srv::BPP2PE::PoseWithUuidStampedEventType _event_;
                ...
                return mDdsInterface->SendEvent<dds::oss::srv::BPP2PE::PoseWithUuidStampedEventType>(kCallSign, _event_);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
...
public:
    ...
    PE_SI_behaviorpathplannerSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~PE_SI_behaviorpathplannerSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    PE_SI_behaviorpathplannerSkeleton(const PE_SI_behaviorpathplannerSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    PE_SI_behaviorpathplannerSkeleton& operator=(const PE_SI_behaviorpathplannerSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    PE_SI_behaviorpathplannerSkeleton(PE_SI_behaviorpathplannerSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    PE_SI_behaviorpathplannerSkeleton& operator=(PE_SI_behaviorpathplannerSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
        mProtocol = std::move(other.mProtocol);
...
#endif /// PARA_COM_GEN_OSS_SRV_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_SKELETON_H