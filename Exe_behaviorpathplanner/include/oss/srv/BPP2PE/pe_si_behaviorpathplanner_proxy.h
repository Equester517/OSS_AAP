...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : pe_si_behaviorpathplanner_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_PROXY_H
#define PARA_COM_GEN_OSS_SRV_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "pe_si_behaviorpathplanner_common.h"
...
public:
    ...
    ara::core::Result<void> Subscribe(size_t maxSampleCount)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                ...
                mMaxSampleCount = maxSampleCount;
                return mDdsInterface->SubscribeEvent<dds::oss::srv::BPP2PE::PoseWithUuidStampedEventType>(kCallSign, mMaxSampleCount);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
    ...
    ara::core::Result<size_t> GetNewSamples(F&& f, size_t maxNumberOfSamples = std::numeric_limits<size_t>::max())
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                auto samples = mDdsInterface->GetNewSamples<dds::oss::srv::BPP2PE::PoseWithUuidStampedEventType>(kCallSign, maxNumberOfSamples);
                for (const auto& sample : samples)
                {
...
class PE_SI_behaviorpathplannerProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<PE_SI_behaviorpathplannerProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        switch (para::com::GetServiceProtocol(instanceSpec))
        {
            case para::com::ServiceProtocol::kSomeIp :
            {
                ...
                auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
                    ara::com::ServiceHandleContainer<PE_SI_behaviorpathplannerProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<PE_SI_behaviorpathplannerProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        switch(para::com::GetServiceProtocol(instanceSpec))
        {
            case para::com::ServiceProtocol::kSomeIp :
            {
                ...
                if (!result.HasValue())
                {
                    return ara::core::Result<ara::com::ServiceHandleContainer<PE_SI_behaviorpathplannerProxy::HandleType>>::FromError(result.Error());
                }
                ara::com::ServiceHandleContainer<PE_SI_behaviorpathplannerProxy::HandleType> handleContainer;
            ...
            #endif /// PARA_DDS_IMPLEMENTATION
            default : return ara::core::Result<ara::com::ServiceHandleContainer<PE_SI_behaviorpathplannerProxy::HandleType>>(ara::com::ComErrc::kNetworkBindingFailure);
        }
    }
    /// @brief Constructor
    ...
    explicit PE_SI_behaviorpathplannerProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , planning_scenarioplanning_modifiedgoal(mInterface.get(), mDdsInterface.get(), mHandle.GetServiceHandle().protocol)
    {
        ...
        {
            mDdsInterface->CreateMethods<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerMethod_Request, dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerMethod_Reply>();
            auto methodReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerMethod_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerMethod_Reply> _samples_;
            ...
            mDdsInterface->CreateFields<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerField_Request, dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerField_Reply>();
            auto fieldReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerField_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::oss::srv::BPP2PE::PE_SI_behaviorpathplannerField_Reply> _samples_;
                _samples_ = _reader_.take();
                for (auto& _sample_ : _samples_)
                {
                    if (_sample_.info().valid())
    ...
    ~PE_SI_behaviorpathplannerProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    PE_SI_behaviorpathplannerProxy(PE_SI_behaviorpathplannerProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    PE_SI_behaviorpathplannerProxy& operator=(const PE_SI_behaviorpathplannerProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    PE_SI_behaviorpathplannerProxy(PE_SI_behaviorpathplannerProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    PE_SI_behaviorpathplannerProxy& operator=(PE_SI_behaviorpathplannerProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
...
#endif /// PARA_COM_GEN_oss_srv_BPP2PE_SERVICE_INTERFACE_PE_SI_BEHAVIORPATHPLANNER_PROXY_H