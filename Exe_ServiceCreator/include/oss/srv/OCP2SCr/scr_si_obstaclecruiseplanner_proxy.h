...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : scr_si_obstaclecruiseplanner_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_OSS_SRV_OCP2SCR_SERVICE_INTERFACE_SCR_SI_OBSTACLECRUISEPLANNER_PROXY_H
#define PARA_COM_GEN_OSS_SRV_OCP2SCR_SERVICE_INTERFACE_SCR_SI_OBSTACLECRUISEPLANNER_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit trajectory(para::com::ProxyInterface* interface, para::com::ProxyDdsInterface* ddsInterface, para::com::ServiceProtocol protocol)
    ...
    ara::core::Result<void> Subscribe(size_t maxSampleCount)
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                ...
                mMaxSampleCount = maxSampleCount;
                return mDdsInterface->SubscribeEvent<dds::oss::srv::OCP2SCr::TrajectoryEventType>(kCallSign, mMaxSampleCount);
            }
            #endif /// PARA_DDS_IMPLEMENTATION
    ...
    ara::core::Result<size_t> GetNewSamples(F&& f, size_t maxNumberOfSamples = std::numeric_limits<size_t>::max())
    {
        switch (mProtocol)
        {
            ...
            case para::com::ServiceProtocol::kDds :
            {
                auto samples = mDdsInterface->GetNewSamples<dds::oss::srv::OCP2SCr::TrajectoryEventType>(kCallSign, maxNumberOfSamples);
                for (const auto& sample : samples)
                {
...
class SCr_SI_obstaclecruiseplannerProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SCr_SI_obstaclecruiseplannerProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        switch (para::com::GetServiceProtocol(instanceSpec))
        {
            case para::com::ServiceProtocol::kSomeIp :
            {
                ...
                auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
                    ara::com::ServiceHandleContainer<SCr_SI_obstaclecruiseplannerProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SCr_SI_obstaclecruiseplannerProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        switch(para::com::GetServiceProtocol(instanceSpec))
        {
            case para::com::ServiceProtocol::kSomeIp :
            {
                ...
                if (!result.HasValue())
                {
                    return ara::core::Result<ara::com::ServiceHandleContainer<SCr_SI_obstaclecruiseplannerProxy::HandleType>>::FromError(result.Error());
                }
                ara::com::ServiceHandleContainer<SCr_SI_obstaclecruiseplannerProxy::HandleType> handleContainer;
            ...
            #endif /// PARA_DDS_IMPLEMENTATION
            default : return ara::core::Result<ara::com::ServiceHandleContainer<SCr_SI_obstaclecruiseplannerProxy::HandleType>>(ara::com::ComErrc::kNetworkBindingFailure);
        }
    }
    /// @brief Constructor
    ...
    explicit SCr_SI_obstaclecruiseplannerProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , trajectory(mInterface.get(), mDdsInterface.get(), mHandle.GetServiceHandle().protocol)
        , scenario(mInterface.get(), mDdsInterface.get(), mHandle.GetServiceHandle().protocol)
    {
        ...
        {
            mDdsInterface->CreateMethods<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerMethod_Request, dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerMethod_Reply>();
            auto methodReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerMethod_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerMethod_Reply> _samples_;
            ...
            mDdsInterface->CreateFields<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerField_Request, dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerField_Reply>();
            auto fieldReplyHandler = [this] (dds::sub::AnyDataReader& dataReader) {
                dds::sub::DataReader<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerField_Reply> _reader_ = dataReader;
                dds::sub::LoanedSamples<dds::oss::srv::OCP2SCr::SCr_SI_obstaclecruiseplannerField_Reply> _samples_;
                _samples_ = _reader_.take();
                for (auto& _sample_ : _samples_)
                {
                    if (_sample_.info().valid())
    ...
    ~SCr_SI_obstaclecruiseplannerProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SCr_SI_obstaclecruiseplannerProxy(SCr_SI_obstaclecruiseplannerProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SCr_SI_obstaclecruiseplannerProxy& operator=(const SCr_SI_obstaclecruiseplannerProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SCr_SI_obstaclecruiseplannerProxy(SCr_SI_obstaclecruiseplannerProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SCr_SI_obstaclecruiseplannerProxy& operator=(SCr_SI_obstaclecruiseplannerProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mDdsInterface = std::move(other.mDdsInterface);
...
#endif /// PARA_COM_GEN_oss_srv_OCP2SCr_SERVICE_INTERFACE_SCR_SI_OBSTACLECRUISEPLANNER_PROXY_H